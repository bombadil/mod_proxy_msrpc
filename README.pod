...
Build the module:
    ...
    apxs -luuid -c mod_proxy_msrpc.c msrpc_pdu_parser.c msrpc_sync.c
...
The mod_proxy_msrpc module detects these MSRPC messages and forwards it to the
...
Currently the module doesn't work in 64 bit environments.
See https://github.com/bombadil/mod_proxy_msrpc/issues/2 for more information
about this issue and for tracking its progress.
